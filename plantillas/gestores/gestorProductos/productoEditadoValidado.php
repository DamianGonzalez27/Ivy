<div class="form-group">
  ...
  <input type="text" class="form-control" <?php $producto -> getNombre()?> name="nombre">
  <div class="form-group">
    <?php
...
<div class="form-group">
  ...
  <textarea class="form-control text-justify texto-entrada" name="descripcion"><?php $producto -> getDescripcion();?></textarea>
  <?php
...
<div class="form-group">
  <label>Precio</label>
  <input type="number" class="form-control" <?php $producto -> getPrecio();?> name="precio">
  <?php
...
<div class="form-group">
  ...
  <input type="text" class="form-control" <?php $producto -> getKeyword();?> name="keyword">
  <?php
