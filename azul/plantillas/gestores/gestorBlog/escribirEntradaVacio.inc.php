...
<input type="text" class="form-control" name="titulo_entrada" placeholder="Título de la entrada">
</div>
<div class="form-group">
<label>Cuerpo de la entrada</label>
<textarea class="form-control text-justify texto-entrada" name="cuerpo_entrada"  placeholder="Escribe aqui tu articulo"></textarea>
</div>
 <br>
 <div class="form-group">
